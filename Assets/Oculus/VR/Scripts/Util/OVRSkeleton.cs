...
public class OVRSkeleton : MonoBehaviour
{
	...
	[SerializeField]
	private bool _kinematicRigidbody = true;
	[SerializeField]
	private float _capsuleMass = 1;
		...
		if (_enablePhysicsCapsules)
		{
			...
			for (int i = 0; i < _capsules.Count; ++i)
			{
				...
				if (capsule.CapsuleRigidbody == null)
				{
					...
					capsule.CapsuleRigidbody.mass = _capsuleMass;
					
					capsule.CapsuleRigidbody.isKinematic = _kinematicRigidbody;
